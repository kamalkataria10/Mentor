...
const Navbar = (
        ...
        const authUserLinks = (
            <Fragment>
                ...
                EduCara<img className="nav-log-img" style={{width: "3.2rem"}} src={require("./doctor (1).png")} />       
                </Link>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item active">
                            <Link to="/profiles" className="nav-link">Mentors</Link>
                        </li>
                        <li className="nav-item active">
            ...
            <Fragment>
                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown active">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <Link className="dropdown-item" to="/loginUser"><i className="fas fa-users"></i> Login as Mentee</Link>
                                <Link className="dropdown-item" to="/loginDoctor"><i className="fas fa-user-md"></i> Login as Mentor</Link>
                            </div>
                        </li>
                    <li className="nav-item dropdown active">
                            <Link className="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <Link className="dropdown-item" to="/registerUser"><i className="fas fa-users"></i> Register as Mentee</Link>
                                <Link className="dropdown-item" to="/registerDoctor"><i className="fas fa-user-md"></i> Register as Mentor</Link>
                            </div>
                        </li>
                </ul>
                </div>

    ...
    >
      ...
      >
        ...
        <div className="column is-3 ">
          ...
          >
            <div className="card-content columns is-multiline" style={{ backgroundColor: "#FB6B90", borderRadius: '30px', display: 'flex', flexDirection: 'column' }}>
              <div className="column is-15" style={{
                ...
                <FontAwesome
                  ...
                  style={{
                    ...
                    color: "white",
                    paddingTop: "5px",
                    fontSize: "2em", display: 'flex', flexDirection: 'column'
                  }}
                >
                </FontAwesome>{" "}
              </div>

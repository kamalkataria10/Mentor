                        ...
                        <div className="form-side">
                            ...
                            <form onSubmit={e => onSubmit(e)}>
                                ...
                                <input 
                                    ...
                                    onChange={e => onChange(e)} required
                                />
                                <small className="form-text text-muted">Company you are working with </small>
                                </div>
                                <div className="form-group">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={e => onChange(e)} required 
                                />
                                <small className="form-text text-muted">Give us an idea of your skills. </small>
                                </div>
                                <div className="form-group">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={e => onChange(e)} required
                                />
                                <small className="form-text text-muted">At which time you would be available for the mentees. </small>
                                </div>
                                <div className="form-group">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={e => onChange(e)} required
                                />
                                <small className="form-text text-muted">At which time you are available for mentees, mention day with time. </small>
                                </div>
                                <div className="form-group">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={e => onChange(e)} required
                                />
                                <small className="form-text text-muted">Could be your own portfolio website </small>
                                </div>
                                <div className="form-group">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={e => onChange(e)} required
                                />
                                <small className="form-text text-muted">Could be your own residential address </small>
                                </div>
                                <div className="form-group">
                                    <textarea 
                                        className="form-control" 
